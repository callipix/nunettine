...
public class ProHuntingController {
	...
	@ResponseBody
	public ArticlePage<ProJoBbscttDto> listAjax(HttpServletRequest request, @RequestBody(required = false) Map<String,Object> paramMap){
		...
		ArticlePage<ProJoBbscttDto> data = new ArticlePage<ProJoBbscttDto>(total, currentPage, size, proHuntingList, keyword);
	...
	@ResponseBody
	public ArticlePage<ProJoBbscttDto> myBoardList(HttpServletRequest request, @RequestBody(required = false) Map<String,Object> paramMap){
		...
		ArticlePage<ProJoBbscttDto> data = new ArticlePage<ProJoBbscttDto>(total, Integer.parseInt(currentPage), size, proHuntingList, keyword);
