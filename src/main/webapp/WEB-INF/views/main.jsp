...
<div>
    <div style="position: relative;">
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%;">
            <img src="../resources/images/풍선3.png" id="balloon"
                 style="width: 1600px; height:700px; margin-left:-125px;">
            <img src="../resources/images/메인3.gif" id="mainImg"
                 style="width: 60%; border-radius: 30px; margin-left:280px;">
        </div>
        <div id="mains" style="position: relative; padding-top:360px;">
            <h3 style="font-family: 'TTHakgyoansimDotbogiR'; color:#4B49AC; text-align:center;">
                <img src='../resources/images/눈.png' style='width:35px; height:auto; backgroun-color:white;'/>&nbsp;눈에
                띄는 프로를 찾아보세요!</h3>
            <div class="input-group" style="width:400px; margin:0 auto;">
                <input type="text" class="form-control" id="keyword" style="font-family: 'GmarketSansMedium';"
                       placeholder="눈에띄는 프로찾기" aria-label="search" aria-describedby="search">
    ...
    <!--서비스 메뉴  -->
    <div id="sevMenu"
         style="display:flex; justify-content: center; text-align:center; font-family: 'GmarketSansMedium'; color:#6c7384; margin-top:130px;">
        <div id="sevMenu1" value="SR2" value2="운동" style="margin-right:50px;"><img src='../resources/images/운동1.png'
                                                                                   style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>운동</h6></div>
        <div id="sevMenu2" value="SR1" value2="반려동물" style="margin-right:50px;"><img src='../resources/images/반려동물3.png'
                                                                                     style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>반려동물</h6></div>
        <div id="sevMenu3" value="SR3" value2="악기" style="margin-right:50px;"><img src='../resources/images/악기4.png'
                                                                                   style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>악기</h6></div>
        <div id="sevMenu4" value="SR4" value2="인테리어" style="margin-right:50px;"><img src='../resources/images/인테리어3.png'
                                                                                     style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>인테리어</h6></div>
        <div id="sevMenu5" value="SR5" value2="취미" style="margin-right:50px;"><img src='../resources/images/취미2.png'
                                                                                   style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>취미</h6></div>
        <div id="sevMenu6" value="SR6" value2="취업/직무" style="margin-right:50px;"><img src='../resources/images/취업2.png'
                                                                                      style='width:60px; height:auto;  margin-bottom:10px;'/><br>
            <h6>취업/직무</h6></div>
        <div id="sevMenu7" value="SR7" value2="기타"><img src='../resources/images/기타2.png'
                                                        style='width:60px; height:auto;  margin-bottom:10px;'/><br><h6>
            기타</h6></div>
    </div>
    ...
    <div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="border-radius:20px; background-color:#f5f7ff;">
                        <c:forEach var="proDto" items="${monthProList}">
                            <div>
                                <img src='/resources/images/축하2.png'
                                ...
                                <c:if test="${proDto.proProflPhoto == null}">
                                    <img src="/images/2024/profile.jpg"
                                         style="width: 120px; height: 120px; border-radius: 70%; margin:20px 0 ;"
                                         alt="profile image">
                                </c:if>
                                <c:if test="${proDto.proProflPhoto != null}">
                                    <img src="${proDto.proProflPhoto}"
                                         style="width: 120px; height: 120px; border-radius: 70%; margin:20px 0 ;"
                                         alt="profile image">
                                </c:if>
                            ...
                            <button class="btn btn-info btn-sm mt-3 mb-4" style="font-family: 'GmarketSansMedium';"
                                    onclick="location.href='/proProfl/detail?proId=${proDto.proId}'">프로필 보러가기
                            </button>
                        </c:forEach>
            ...
            <div class="card-body">
                <div style="display:flex; flex-wrap: wrap; align-items: center;">
                    <h3 style="font-family: 'seolleimcool-SemiBold';">
                        <img src="../resources/images/구인.png"
                             style="width:50px; height:auto; margin-right:5px; background-color:white; vertical-align: middle;"
                             alt="구인아이콘"/>
                        프로 구인 게시판
                    </h3>
                    <h4 style="font-family: 'GmarketSansMedium'; margin-left:400px; color:#a7a7a7;">전체 보기</h4>
                    <img src="../resources/images/화살표.png" id="readAll"
                         style="width:30px; height:auto; margin:-10px 0 0 20px; background-color:white; " alt="화살표아이콘"/>
                </div>
        ...
        <div style="margin:60px -235px 80px 320px;">
            <h3 style="font-family: 'seolleimcool-SemiBold';">
                <img src="../resources/images/불이야.png"
                     style="width:35px; height:auto; margin-right:5px; background-color:white; vertical-align: middle;"
                     alt="hot아이콘"/>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                        <figure class="effect-text-in" style="background:#f6e28b">
                            ...
                            <a href="/prostory/getStory?storyNo=${Dto.proStoryBbscttNo}">
                                ...
                                <figcaption>
                                    <h4 class="proStorylTitle"
                                        style="font-family: 'GmarketSansMedium';">${Dto.proStoryBbscttSj}</h4>
        ...
        <div style="margin:80px -235px 80px 320px;">
            <h3 style="font-family: 'seolleimcool-SemiBold';">
                <img src="../resources/images/수업.png"
                     style="width:35px; height:auto; margin-right:5px; background-color:white; vertical-align: middle;"
                     alt="원데이클래스아이콘"/>
                지금 인기있는 원데이 클래스!
            </h3>
                ...
                <div class="col-4 outterDiv">
                    <a href='/onedayClass/onedayClassDetail?ondyclNo=${ondyclDtoList[0].ondyclNo}&mberId=${memSession.userId}&mainck=main'>
                        ...
                        <figure class="effect-text-in" style="background:#98b3e8">
                            ...
                            <figcaption>
                                <h4 class='ondyclTitle'
                                    style="font-family: 'GmarketSansMedium';">${ondyclDtoList[0].ondyclNm}</h4>
                ...
                <div class="col-4 outterDiv">
                    <a href='/onedayClass/onedayClassDetail?ondyclNo=${ondyclDtoList[1].ondyclNo}&mberId=${memSession.userId}&mainck=main'>
                        ...
                        <figure class="effect-text-in" style="background:#98b3e8">
                            ...
                            <figcaption>
                                <h4 class='ondyclTitle'
                                    style="font-family: 'GmarketSansMedium';">${ondyclDtoList[1].ondyclNm}</h4>
                ...
                <div class="col-4 outterDiv">
                    <a href='/onedayClass/onedayClassDetail?ondyclNo=${ondyclDtoList[2].ondyclNo}&mberId=${memSession.userId}&mainck=main'>
                        ...
                        <figure class="effect-text-in" style="background:#98b3e8">
                            ...
                            <figcaption>
                                <h4 class='ondyclTitle'
                                    style="font-family: 'GmarketSansMedium';">${ondyclDtoList[2].ondyclNm}</h4>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="serModalBody" style="height:auto; margin:20px 0 0 30px;">
                    <div class="form-group">
                        ...
                        <div class="form-group" style="margin-left:15px;">
                            ...
                            <select id="spcltyB" name="spcltyB" class="form-control"
                                    style="width:400px; font-family: 'GmarketSansMedium';">
                                <option selected>대분류를 선택해주세요</option>
                                <c:forEach items="${spcltyBList}" var="spcltyBDto">
                                    <c:if test="${spcltyBDto.lev eq 1}">
                                        <option value="${spcltyBDto.spcltyRealmCode}"
                                                value2="${spcltyBDto.spcltyRealmNm}">${spcltyBDto.spcltyRealmNm}</option>
                                    </c:if>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group" id="b2Cla" style="margin-left:15px;">
                            ...
                            <select id="spcltyB2" name="spcltyB2" class="form-control"
                                    style="width:400px; font-family: 'GmarketSansMedium';">
                        ...
                        <div class="form-group" id="b3Cla" style="margin-left:15px;">
                            ...
                            <select id="spcltyB3" name="spcltyB3" class="form-control"
                                    style="width:400px; font-family: 'GmarketSansMedium';">
                ...
                <div class="modal-footer" style="border-top:none;">
                    <button class="btn btn-primary" type="submit" id="searchServBtn"
                            style="font-family: 'GmarketSansMedium';">확인
                    </button>
                    <button type="button" id="dissbtn" class="btn btn-light" style="font-family: 'GmarketSansMedium';"
