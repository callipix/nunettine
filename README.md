...
<div> 
  ...
  <div style="font-weight: 700; font-size: 15px; color: #282d33;" align="center">
   생활 서비스에 대한 전문가(이하 프로)들을 보다 쉽게 찾을 수 있고, 해당 서비스를 편리하게 제공하고자
<br>기존에 존재하는 ‘숨고’ 라는 플랫폼을 모티브로 하여 우리만의 스타일로 재구성해보았으며, 내게 필요한 프로가
<br>어디에서나 쉽게 눈에 띄었으면 하는 바람을 가지고 ‘누네띠네’ 라고 이름지었습니다.
<br>
    <br>
   PL을 포함한 총 **7명의 구성원**으로 팀이 구성되어 있으며 약 2달간 진행하였습니다.<br>
   ERDCloud를 활용하여 ERD를 작성하였으며 44개의 테이블을 사용하였습니다.
  </div>
<br><br>
</div>
...
<img src="https://img.shields.io/badge/Apache Tomcat 8.5-F8DC75?style=Plastic&logo=apachetomcat&logoColor=white" />
...
<div style="color: black">
  ...
  <b><font size="6">모든 이용자 공통</font></b>
     <p style="margin-top: 0;">게시글 조회(후기, 자유, 프로구인, 프로이야기), 프로랭킹, 프로 별점 평가 및 리뷰, 원데이클래스, 사이트 이용 FAQ</p>
<br>
  ...
  <p>
    ...
    <br>
    오늘모임 - 일반회원/프로 관계없이 누구든 생성 가능 하며 생성 후 채팅과 함께 모임 진행(생성과 동시에 기본적으로 채팅방이 존재)    
  </p>
...
<b><font size="6">프로</font></b>
  ...
  <br>
  프로프로필 - 마이페이지와는 별도로 자신의 서비스 분야에 대한 설명 및 요청서 안내와 포트폴리오를 등록하는 페이지
  <br>
  프로이야기 - 프로만 작성가능하며 자신의 에피소드 등을 이야기 형식으로 풀어내는 게시판
  <br>
  프로탈퇴 - 원데이클래스에서의 결제로 인한 회원/프로간의 금전문제를 방지하고자 탈퇴요청 후 관리자의 승인하에 탈퇴 가능
  </p>
...
<br>
 <div align="center">
  <img style="width:30%" src="https://github.com/user-attachments/assets/6df23bd8-1a59-4581-a40c-6aa44b1eee6b">
  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
