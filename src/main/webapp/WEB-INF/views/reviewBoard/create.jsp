        ...
        <div class="col-lg-12">
            <div class="card px-2">
                <div class="card-body">
                    ...
                    <form action="/reviewBoard/createAjax" id="rvInsertForm" name="frm" class="forms-sample"
                          method="post" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" id="srvcRequstNo" name="srvcRequstNo"
                               value="${srvcRequstNo}" required>
