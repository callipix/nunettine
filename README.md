...
<div> 
  ...
  <div style="font-weight: 700; font-size: 15px; color: #282d33;" align="center">
   생활 서비스에 대한 전문가(이하 프로)들을 보다 쉽게 찾고 제공하고자 기존에 존재하는 ‘숨고’ 라는 플랫폼을 모티브로 하여<br> 우리만의 스타일로 재구성해보았으며, 내게 필요한 프로가 어디에서나 쉽게 눈에 띄었으면 하는 의미로 ‘누네띠네’ 라고 이름지었습니다.<br>
    <br>
...
<br>
<div>
  <h2 style="color: #282d33;"> 🛠️ 프로젝트 사용기술 및 개발환경</h2>
</div>
