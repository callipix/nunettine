...
public class OnedayClassController {
	...
	public ArticlePage<BundleOndyclDto> mberShoppingCartAjax(@RequestBody(required = false) Map<String, Object> map) {
		...
		ArticlePage<BundleOndyclDto> data = new ArticlePage<BundleOndyclDto>(total, currentPage, size,
			shopngBundleDtoList, keyword);
	...
	public ArticlePage<VOndyclProUsersDto> memberOndyclListAjax(
		@RequestBody(required = false) Map<String, Object> map) throws ParseException {
		...
		ArticlePage<VOndyclProUsersDto> data = new ArticlePage<VOndyclProUsersDto>(total, currentPage, size,
			vOndyclProUsersDtoList, keyword);
