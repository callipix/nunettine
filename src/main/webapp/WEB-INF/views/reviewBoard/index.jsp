...
<div class="container col-lg-12">
    ...
    <div class="col-12 stretch-card grid-margin grid-margin-md-0">
        <div class="card">
            <!-- 제목 -->
            <div>
                <img alt="후기" src="../resources/images/게후기.png"
                     style="width:100px; height:auto; margin:0 0 20px 600px;">
                <h2 id="freeTitle"
                    style="text-align:center; font-family: 'seolleimcool-SemiBold'; color:#4e4c7c; text-shadow: -2px 0px white, 0px 2px white, 2px 0px white, 0px -2px white;">
                    후기게시판</h2>
            ...
            <div class="card-body">
                ...
                <div>
                    <button type="button" class="btn btn-inverse-primary btn-sm" data-toggle="modal"
                            data-target="#modal-Create" id="btnRvCreate"
                            style="display: none; float: right; margin: 3px 5px 0 0; ">후기등록
                    </button>
                </div>
