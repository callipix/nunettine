                ...
                <div class="card-body" style="font-family: 'GmarketSansMedium'; margin-top: -50px;">
                    <blockquote>
                        ...
                        <div class="form-group">
                            <c:forEach var="sprviseAtchmnflDto" items="${sprviseAtchmnflDtoList.spAtDtoList}"
                                       varStatus="stat">
                                <%-- 						<label for="Images" id="Images">${sprviseAtchmnflDto.atchmnflNm}</label> --%>
                                <%-- 						<p><b>첨부파일 : ${sprviseAtchmnflDto.atchmnflNm}</b></p> --%>
                                <p><a href="${sprviseAtchmnflDto.atchmnflCours}"
                                      download="${sprviseAtchmnflDto.atchmnflNm}">첨부파일
                                    :${sprviseAtchmnflDto.atchmnflNm}</a></p>
